...
AIRPORTS = ('ATL', 'LAX', 'ORD', 'DFW', 'DEN', 'JFK', 'SFO', 'LAS', 'PHX', 'IAH', 'DEN', 'CLT', 'LAS', 'MCO', 'SEA', 'MIA', 'FLL', 'SFO')
...
def increment_date_on_page(page):
    """
...
def get_flight_data(page) -> list[dict[str, str]]:
    """Gets flight data"""
